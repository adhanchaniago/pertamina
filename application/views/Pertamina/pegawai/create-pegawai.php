				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<select name="katagori" class="form-control">
							...
							<option value="pekerja" <?php if($this->input->get('katagori')=='pekerja') echo 'selected'; ?>>Pekerja</option>
				        	<option value="pengawas" <?php if($this->input->get('katagori')=='pengawas') echo 'selected'; ?>>Pengawas</option>
						</select>
