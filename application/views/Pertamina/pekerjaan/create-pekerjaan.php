...
?>
			<div class="box-body" style="margin-top: 10px;">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="no_pekerjaan" class="form-control" value="<?php echo set_value('no_pekerjaan'); ?>" placeholder="Nomor Pekerjaan">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="nama_pekerjaan" class="form-control" value="<?php echo set_value('nama_pekerjaan'); ?>" placeholder="Nama Pekerjaan">
						<p class="help-block"><?php echo form_error('nama_pekerjaan', '<small class="text-red">', '</small>'); ?></p>
					</div>
				</div>
				<div class="form-group">
                    <label for="deskripsi" class="control-label col-md-3 col-xs-12">Information : <strong class="text-red">*</strong></label>
                   	<div class="col-md-8">
                   		<textarea name="keterangan" rows="6" class="form-control" value="<?php echo set_value('keterangan'); ?>" placeholder="Keterangan"></textarea>
