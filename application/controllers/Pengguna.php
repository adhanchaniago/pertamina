...
class Pengguna extends Pertamina {
	...
	public function index() 
	{
		...
		$this->template->view('Pertamina/pengguna/data-pengguna', $this->data);
	}
	...
	public function create()
	{
		...
		$this->template->view('Pertamina/pengguna/create-pengguna', $this->data);
	}
	...
	public function update($param = 0)
	{
		...
		$this->template->view('Pertamina/pengguna/update-pengguna', $this->data);
	}
